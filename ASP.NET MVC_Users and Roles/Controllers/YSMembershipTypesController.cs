...
{
    public class YSMembershipTypesController : Controller
    {
        private readonly SailContext _context;

        public YSMembershipTypesController(SailContext context)
        {
            _context = context;
        }

        // GET: YSMembershipTypes
        public async Task<IActionResult> Index()
        {
            return View(await _context.MembershipType.ToListAsync());
        }

        // GET: YSMembershipTypes/Details/5
        ...
        // GET: YSMembershipTypes/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: YSMembershipTypes/Create
        ...
        // GET: YSMembershipTypes/Delete/5
        ...
        // POST: YSMembershipTypes/Delete/5
