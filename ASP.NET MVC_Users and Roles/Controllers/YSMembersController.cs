...
{
    public class YSMembersController : Controller
    {
        private readonly SailContext _context;

        public YSMembersController(SailContext context)
        {
            _context = context;
        }
