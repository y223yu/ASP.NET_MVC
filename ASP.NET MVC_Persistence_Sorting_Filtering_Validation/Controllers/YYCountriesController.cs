...
{
    public class YYCountriesController : Controller
    {
        private readonly SailContext _context;

        public YYCountriesController(SailContext context)
        {
            _context = context;
        }
        ...
        // GET: YYCountries/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: YYCountries/Create
